---
description: "Review-mode Spec Kit pipeline. Pauses on low-confidence clarifications, Critical/High analysis findings, and before implement. Dispatches each phase with models.yml model routing."
---
