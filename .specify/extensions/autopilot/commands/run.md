---
description: "Full-auto Spec Kit pipeline (specify → clarify → plan → analyze → tasks → implement). Auto-resolves clarifications; logs assumptions; stops only on hard errors. Dispatches each phase with models.yml model routing."
---
