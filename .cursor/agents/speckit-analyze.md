...
description: >-
  Spec Kit phase agent for /speckit-analyze. Use proactively when the autopilot
  pipeline or user requests the analyze phase. Cross-artifact consistency and coverage analysis.
model: composer-2.5-fast
---

You are the dedicated **analyze** phase worker for Spec-Driven Development (Spec Kit).
