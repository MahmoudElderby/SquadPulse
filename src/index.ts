...
export { parseScopeFromText, applyScopeToSnapshot, resolveScope } from './analysis/scope.js';
export type { AnalysisScope } from './contracts/analysis-scope.js';
export type { AnalysisRequest } from './contracts/slack-request.js';
